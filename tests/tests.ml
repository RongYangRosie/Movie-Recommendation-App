...
(* test suite for vote_average *)
let tests_vote_average _ = 
  assert_equal 2. @@ vote_average [r1];
  assert_equal 3. @@ vote_average [r1; r2];
  assert_equal 4. @@ vote_average [r1; r2; r3]
...
let tests_quantile _ = 
  assert_equal 9.1 @@ Demographic_mode.quantile data
...
let result = [{Movie.movie_id = 1; title = "Avatar"; cast = []; director = "";
  keywords = []; genres = []; overview = ""; popularity = 1.; vote_count = 10;
  vote_average = 1.}]
let test_filter_vote_count _ = 
  assert_equal result @@ Demographic_mode.filter_vote_count data
...
let result = [{Movie.movie_id = 1; title = "Avatar"; cast = []; director = "";
  ...
  keywords = []; genres = []; overview = ""; popularity = 1.; vote_count = 8;
  vote_average = 1.}]
let test_sort_by_weighted_rating _ = 
  assert_equal result @@ Demographic_mode.sort_by_weighted_rating data
...
let test_sort_by_popularity _ = 
  assert_equal [r3; r2; r1] @@ sort_by_popularity [r1; r2; r3]
...
let test_sort _ = 
  assert_equal result @@ Demographic_mode.sort data  
...
let test_mode1_get_recommendations _ = 
  assert_equal [r1; r2; r3] @@ Demographic_mode.get_recommendations [r1; r2; r3; r4; r5; r6] 3
let mode1_tests = 
  "Mode1 Test"
  >: test_list [
    "Vote average" >:: tests_vote_average; 
    "Quantile" >:: tests_quantile;
    "Filter vote count" >:: test_filter_vote_count;
    "Sort by weighted rating" >:: test_sort_by_weighted_rating;
    "Sort by popularity" >:: test_sort_by_popularity;
    "Sort" >:: test_sort;
    "Mode1 Get recommendations" >:: test_mode1_get_recommendations
  ]
...
let series = 
  "Whole Test" >::: [utils_tests; mode1_tests; mode2_tests; mode3_tests]

let _ = run_test_tt_main series